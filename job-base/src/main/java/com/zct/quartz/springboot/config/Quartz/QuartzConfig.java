package com.zct.quartz.springboot.config.Quartz;
...
public class QuartzConfig {
	...
	public Properties quartzProperties() throws IOException {
		...
		prop.setProperty("org.quartz.dataSource.quartzDataSource.connectionProvider.class", "com.zct.quartz.springboot.config.Quartz.CustomerQuartzDataSource");
